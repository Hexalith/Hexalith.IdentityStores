...
Write-Verbose "Replacing 'IdentityStores' with '$PackageName' in all files..."
Write-Verbose "Also replacing 'IdentityStores' with '$($PackageName.ToLower())' in all files..."
...
function ProcessFile {
    ...
    try {
        ...
        if ($content -match "IdentityStores") {
            $content = $content -replace "IdentityStores", $PackageName
            $hasChanges = $true
        }
        
        if ($content -match "IdentityStores") {
            $content = $content -replace "IdentityStores", $PackageName.ToLower()
            $hasChanges = $true
        }
...
Rename-ProjectItems -SearchPattern "IdentityStores" -Replacement $PackageName -ItemType Directory
Rename-ProjectItems -SearchPattern "IdentityStores" -Replacement $PackageName -ItemType File
Rename-ProjectItems -SearchPattern "IdentityStores" -Replacement $PackageName.ToLower() -ItemType Directory
Rename-ProjectItems -SearchPattern "IdentityStores" -Replacement $PackageName.ToLower() -ItemType File
...
Write-Output "Package name has been changed from 'IdentityStores' to '$PackageName'"
Write-Output "Lowercase 'IdentityStores' has been changed to '$($PackageName.ToLower())'" 